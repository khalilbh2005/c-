...
public:
    ...
    Piece plusGrandePiece() const;// retourne la Piece la plus grande piece de l'appartement
    ...
    //------------ methodes pour les recherches
    int recherche(const string &)const;
    int recherchePremier(const string &)const;
  };
#endif
